<aside class="w-64 bg-white shadow-lg min-h-screen p-6 space-y-6">
  ...
  <nav class="flex flex-col space-y-4">
    ...
    ?>
      ...
      <a href="mywallet.php" class="text-gray-700 hover:text-blue-500 font-medium">💰 my wallet</a>
    ...
    <?php if ($stype != "Guest") { ?>
      ...
      <a href="profile.php" class="text-gray-700 hover:text-blue-500 font-medium">⚙️ Profile </a>
       <a href="logout.php" class="text-gray-700 hover:text-blue-500 font-medium">😱 Logout</a>
    <?php } ?>
    <?php if ($stype != "vendor") { ?>
    ...
    <a href="team.php" class="text-gray-700 hover:text-blue-500 font-medium">👨‍🏭Meet👨‍🏭the👨‍🏭Team👨‍🏭👨‍🏭</a>
  </nav>
</aside>